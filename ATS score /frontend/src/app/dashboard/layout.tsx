...
import {
  ...
  Building2, GitBranch, Key, Shield, LogOut, Plus, Menu,
  ChevronRight, Home, Mic, BookOpen, Target, Briefcase,
} from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // One piece of markup shown in both the desktop sidebar and the mobile overlay.
