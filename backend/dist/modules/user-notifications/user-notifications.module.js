...
exports.UserNotificationsModule = UserNotificationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [user_notifications_controller_1.UserNotificationsController],
        providers: [user_notifications_service_1.UserNotificationsService],
        exports: [user_notifications_service_1.UserNotificationsService],
    })
